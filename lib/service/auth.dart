...
class AuthClass {
  ...
  signingwithgoogle(context) async {
  ...
  Navigator.pushAndRemoveUntil(context,
          MaterialPageRoute(builder: (builder) => MyNavigationBar()), (route) => false);
  ...
  Future<void> signInwithPhoneNumber(
    ...
    try {
      ...
      Navigator.pushAndRemoveUntil(context,
          MaterialPageRoute(builder: (builder) => OtpVerifyScreen()), (route) => false);
